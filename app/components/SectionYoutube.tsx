...
export const SectionYoutube = () => {
  ...
  return (
    <section className="w-full bg-gradient-to-b from-blue-600 to-[#2D5FFE] md:bg-[#2D5FFE] overflow-hidden flex flex-col items-center pb-16">
      {/* Yellow Tab */}
      <div className="inline-block bg-[#FFDD00] text-black font-black px-6 py-1 rounded-t-[26px] text-[11] md:text-2xl tracking-wide shadow-md">
        Program Youtube
      </div>
      ...
      <div className="w-full max-w-[1440px] px-4 md:px-[33px] mt-4 md:mt-8">
        <div className="flex flex-row md:flex-wrap lg:flex-nowrap justify-start md:justify-center overflow-x-auto gap-2 md:gap-[26px] pb-2 md:pb-0" role="tablist">
          {videos.map((video, i) => (
            <div
              key={video.id}
              role="tab"
