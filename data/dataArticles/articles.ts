...
export const articles: Article[] = [
...

  {
    ...
    category: "sport",
    thumbnail: {
      thumbnailUrl: "/image/articles/Rectangle 17.png",
      title: "Timas Lolos Kualifikasi Piala Dunia 2026, Ini Kata Pelatih",
      desc: "Tim nasional Indonesia berhasil lolos ke babak kualifikasi Piala Dunia 2026 setelah meraih kemenangan penting dalam pertandingan terakhir mereka. Pelatih tim nasional Indonesia, Coach Andi, memberikan komentar tentang pencapaian ini dan apa yang diharapkan dari tim ke depannya. Dalam artikel ini, kita akan membahas perjalanan tim nasional Indonesia menuju kualifikasi Piala Dunia 2026 dan apa yang dikatakan oleh pelatih tentang prestasi ini.",
    },
    contents: [
      {
        type: "paragraph",
        text: "Tim nasional Indonesia berhasil lolos ke babak kualifikasi Piala Dunia 2026 setelah meraih kemenangan penting dalam pertandingan terakhir mereka. Pelatih tim nasional Indonesia, Coach Andi, memberikan komentar tentang pencapaian ini dan apa yang diharapkan dari tim ke depannya. Dalam artikel ini, kita akan membahas perjalanan tim nasional Indonesia menuju kualifikasi Piala Dunia 2026 dan apa yang dikatakan oleh pelatih tentang prestasi ini.",
      },
    ],
  },
];
